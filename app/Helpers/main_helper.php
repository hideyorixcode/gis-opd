...
function getDataUser($id)
{
    ...
    $data = $mpengguna->select(['username', 'active', 'id_unker', 'nama_unker', 'singkatan_unker', 'latitude', 'longitude', 'alamat', 'no_telepon', 'email', 'website', 'nip_pejabat', 'nama_pejabat', 'status', 'logo'])->where('id', $id)->first();
    return $data;
}
