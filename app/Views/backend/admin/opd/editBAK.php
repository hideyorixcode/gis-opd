    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard/opd') ?>">OPD</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12">
                <div class="card-box">
                    <h4 class="header-title m-t-0">Form Ubah Data OPD</h4>
                    <p class="text-muted font-14 m-b-20">
                        Silahkan lengkapi data berikut ini, tanda <span class="text-danger">*</span> wajib diisi
                    </p>

                    <form id="form" name="form" method="post" enctype="multipart/form-data"
                          action="<?= base_url('dashboard/opd/update') ?>">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-lg-8">
                                <input type="hidden" id="status" name="status" value="OPD">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="nama_unker" name="nama_unker" placeholder="Nama OPD" required
                                           autofocus
                                ...
                                <div class="form-group mb-3">
                                    <label>Singkatan OPD <span class="text-danger">*</span></label>
                                    <input type="text"
                                           class="form-control <?= ($validation->hasError('singkatan_unker')) ? 'is-invalid' : '' ?>"
                                           id="singkatan_unker" name="singkatan_unker" placeholder="Singkatan/Alias OPD"
                                           required
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group mb-3">
                                    <label>ID OPD <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroupPrepend">ID</span>
                                        </div>
                                        <input type="text"
                                               class="form-control <?= ($validation->hasError('id_unker')) ? 'is-invalid' : '' ?>"
                                               id="id_unker" name="id_unker" placeholder="ID unik untuk OPD"
                                               aria-describedby="inputGroupPrepend" required
                                               onkeypress="return check_int(event)"
                                               maxlength="10"
                                               value="<?= old('id_unker') ? old('id_unker') : $data['id_unker'] ?>">
                                        <div class="invalid-feedback">
                                            <?= $validation->getError('id_unker'); ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="password"
                                           ...
                                           placeholder="Konfirmasi Password, kosongkan apbila tidak ingin merubah password"
